---
title: Bienestar Estudiantil - PUCMM | Landing Page
published: 2025-01-30
description: "Landing page para el portal de Bienestar Estudiantil de la Pontificia Universidad Católica Madre y Maestra. (PUCMM)."
image: "./cover.png"
...
![Sección de Exploración](./explore-section.webp)

- Sección de Actividades
![Sección de Actividades](./activities-section.webp)

- Sección de Noticias
![Sección de Noticias](./news-section.webp)
...
- Página del Decanato
![Página del Decanato](./dean-page.webp)

- Página de Salud
![Página de Salud](./health-page.webp)

- Página de Beneficios
![Página de Beneficios](./benefits-page.webp)

- Página de Artes
![Página de Artes](./arts-page.webp)

- Página de Asociaciones
![Página de Asociaciones](./associations-page.webp)

##### Ejemplo de Asociación

- Página de CICC
![Página de CICC](./cicc-page.webp)
